...
void drawPanelHeader(juce::Graphics &g, juce::Rectangle<int> area,
...
AdaptiveEchoAudioProcessorEditor::AdaptiveEchoAudioProcessorEditor(
  ...
  loadPresetButton.setColour(juce::TextButton::buttonColourId, kAccentBlueSoft);
  loadPresetButton.setColour(juce::TextButton::buttonOnColourId, kAccentBlue);
  loadPresetButton.setColour(juce::TextButton::textColourOffId, kPrimaryText);
  savePresetButton.setColour(juce::TextButton::buttonColourId, kAccentBlueSoft);
  savePresetButton.setColour(juce::TextButton::buttonOnColourId, kAccentBlue);
  savePresetButton.setColour(juce::TextButton::textColourOffId, kPrimaryText);
  ...
  trainButton.setColour(juce::TextButton::textColourOffId,
                        juce::Colours::white);
  ...
  samplePathLabel.setColour(juce::Label::outlineColourId,
                            juce::Colours::transparentBlack);
  samplePathLabel.setFont(juce::FontOptions(14.0f));
  addAndMakeVisible(samplePathLabel);

  presetPathLabel.setText("No preset loaded", juce::dontSendNotification);
  presetPathLabel.setJustificationType(juce::Justification::centredLeft);
  presetPathLabel.setColour(juce::Label::textColourId, kPrimaryText);
  presetPathLabel.setColour(juce::Label::backgroundColourId, kAccentBlueSoft);
  presetPathLabel.setColour(juce::Label::outlineColourId,
                            juce::Colours::transparentBlack);
  presetPathLabel.setFont(juce::FontOptions(14.0f));
  ...
  trainingProgressBar.setColour(juce::ProgressBar::foregroundColourId,
                                kAccentBlue);
  ...
  trainingTimeSlider.setColour(juce::Slider::textBoxOutlineColourId,
                               juce::Colours::transparentBlack);
  trainingTimeSlider.setColour(juce::Slider::trackColourId,
  ...
  referenceFrequencySlider.setSliderStyle(
      juce::Slider::RotaryHorizontalVerticalDrag);
  referenceFrequencySlider.setTextBoxStyle(juce::Slider::TextBoxBelow, false,
                                           120, 24);
  referenceFrequencySlider.setSkewFactorFromMidPoint(440.0);
  referenceFrequencySlider.setColour(juce::Slider::textBoxTextColourId,
                                     kPrimaryText);
  referenceFrequencySlider.setColour(juce::Slider::textBoxOutlineColourId,
                                     juce::Colours::transparentBlack);
  referenceFrequencySlider.setColour(juce::Slider::rotarySliderFillColourId,
                                     kAccentBlue);
  referenceFrequencySlider.setColour(juce::Slider::rotarySliderOutlineColourId,
                                     kAccentBlue.withAlpha(0.22f));
  referenceFrequencySlider.setColour(juce::Slider::thumbColourId,
                                     kAccentBlueDark);
  addAndMakeVisible(referenceFrequencySlider);

  oscAPitchTrackToggle.setColour(juce::ToggleButton::textColourId,
                                 kPrimaryText);
  oscAPitchTrackToggle.setColour(juce::ToggleButton::tickColourId,
                                 kAccentBlueDark);
  oscAPitchTrackToggle.setColour(juce::ToggleButton::tickDisabledColourId,
                                 kSecondaryText);
  oscBPitchTrackToggle.setColour(juce::ToggleButton::textColourId,
                                 kPrimaryText);
  oscBPitchTrackToggle.setColour(juce::ToggleButton::tickColourId,
                                 kAccentBlueDark);
  oscBPitchTrackToggle.setColour(juce::ToggleButton::tickDisabledColourId,
                                 kSecondaryText);
  singleVoiceToggle.setColour(juce::ToggleButton::textColourId, kPrimaryText);
  singleVoiceToggle.setColour(juce::ToggleButton::tickColourId,
                              kAccentBlueDark);
  singleVoiceToggle.setColour(juce::ToggleButton::tickDisabledColourId,
                              kSecondaryText);
  constantVelocityToggle.setColour(juce::ToggleButton::textColourId,
                                   kPrimaryText);
  constantVelocityToggle.setColour(juce::ToggleButton::tickColourId,
                                   kAccentBlueDark);
  constantVelocityToggle.setColour(juce::ToggleButton::tickDisabledColourId,
                                   kSecondaryText);
  ...
  configureEffectSlider(preHighPassCutoffSlider, preHighPassCutoffLabel,
                        "Pre HP Cutoff");
  configureEffectSlider(preHighPassSlopeSlider, preHighPassSlopeLabel,
                        "Pre HP Slope");
  configureEffectSlider(preLowPassCutoffSlider, preLowPassCutoffLabel,
                        "Pre LP Cutoff");
  configureEffectSlider(preLowPassSlopeSlider, preLowPassSlopeLabel,
                        "Pre LP Slope");
  ...
  oscAPitchTrackAttachment =
      std::make_unique<juce::AudioProcessorValueTreeState::ButtonAttachment>(
          audioProcessor.getParameters(),
          adaptive_echo::plugin_parameters::kOscAPitchTrackId,
          oscAPitchTrackToggle);
  oscBPitchTrackAttachment =
      std::make_unique<juce::AudioProcessorValueTreeState::ButtonAttachment>(
          audioProcessor.getParameters(),
          adaptive_echo::plugin_parameters::kOscBPitchTrackId,
          oscBPitchTrackToggle);
  singleVoiceAttachment =
      std::make_unique<juce::AudioProcessorValueTreeState::ButtonAttachment>(
          audioProcessor.getParameters(),
          adaptive_echo::plugin_parameters::kSingleVoiceId, singleVoiceToggle);
  ...
  highPassCutoffAttachment =
      std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(
          audioProcessor.getParameters(),
          adaptive_echo::plugin_parameters::kHighPassCutoffId,
...
void AdaptiveEchoAudioProcessorEditor::paint(juce::Graphics &g) {
  ...
  auto leftControls =
      controlsArea.removeFromLeft((controlsArea.getWidth() - 12) / 2);
  ...
  g.drawText("Adaptive Echo", hero.removeFromTop(38),
             juce::Justification::centredLeft, false);

  drawPanelHeader(g, trainingArea.reduced(20).removeFromTop(24), "Training");
  drawPanelHeader(g, leftControls.reduced(20).removeFromTop(24),
                  "Source Controls");
  drawPanelHeader(g, rightControls.reduced(20).removeFromTop(24),
                  "Output Controls");
...
void AdaptiveEchoAudioProcessorEditor::resized() {
  ...
  trainingTimeLabel.setBounds(actionRow.removeFromLeft(96));
  actionRow.removeFromLeft(8);
  trainingTimeSlider.setBounds(actionRow.removeFromLeft(180));
  actionRow.removeFromLeft(14);
  loadSampleButton.setBounds(actionRow.removeFromLeft(132));
  actionRow.removeFromLeft(10);
  loadPresetButton.setBounds(actionRow.removeFromLeft(132));
  actionRow.removeFromLeft(10);
  savePresetButton.setBounds(actionRow.removeFromLeft(132));
  actionRow.removeFromLeft(10);
  trainButton.setBounds(actionRow.removeFromLeft(120));

  trainingArea.removeFromTop(8);
  auto pathRow = trainingArea.removeFromTop(28);
  samplePathLabel.setBounds(
      pathRow.removeFromLeft((pathRow.getWidth() - 8) / 2));
  pathRow.removeFromLeft(8);
  presetPathLabel.setBounds(pathRow);
  trainingArea.removeFromTop(8);
  ...
  auto layoutKnob = [](juce::Rectangle<int> area, juce::Label &label,
                       juce::Slider &slider) {
...
void AdaptiveEchoAudioProcessorEditor::buttonClicked(juce::Button *button) {
  if (button == &loadSampleButton) {
    fileChooser =
        std::make_unique<juce::FileChooser>("Choose a sample to train");
  ...
  if (button == &loadPresetButton) {
    fileChooser = std::make_unique<juce::FileChooser>(
        "Load Adaptive Echo preset", getDefaultPresetFile(),
        "*" + juce::String(adaptive_echo::plugin_files::kPresetFileExtension));
    auto flags = juce::FileBrowserComponent::openMode |
                 juce::FileBrowserComponent::canSelectFiles;
    fileChooser->launchAsync(flags, [this](const juce::FileChooser &chooser) {
      const auto file = chooser.getResult();
      if (file.existsAsFile()) {
        audioProcessor.loadPresetFromPath(file.getFullPathName());
      }
      fileChooser.reset();
    });
    return;
  ...
  if (button == &savePresetButton) {
    fileChooser = std::make_unique<juce::FileChooser>(
        "Save Adaptive Echo preset", getDefaultPresetFile(),
        "*" + juce::String(adaptive_echo::plugin_files::kPresetFileExtension));
    ...
    fileChooser->launchAsync(flags, [this](const juce::FileChooser &chooser) {
      const auto file = chooser.getResult();
      if (file != juce::File()) {
        audioProcessor.savePresetToPath(file.getFullPathName());
      }
      fileChooser.reset();
    });
    return;
...
void AdaptiveEchoAudioProcessorEditor::changeListenerCallback(
...
void AdaptiveEchoAudioProcessorEditor::refreshFromProcessor() {
  ...
  const auto presetPath = audioProcessor.getPresetPath();
  samplePathLabel.setText(samplePath.isNotEmpty() ? samplePath
                                                  : "No sample loaded",
                          juce::dontSendNotification);
  presetPathLabel.setText(presetPath.isNotEmpty() ? presetPath
                                                  : "No preset loaded",
                          juce::dontSendNotification);
  statusLabel.setText(audioProcessor.getStatusText(),
                      juce::dontSendNotification);
  ...
  const auto shouldShowProgress = audioProcessor.isTraining() ||
...
juce::File AdaptiveEchoAudioProcessorEditor::getDefaultPresetFile() const {
  const auto presetPath = audioProcessor.getPresetPath();
  if (presetPath.isNotEmpty()) {
    return juce::File(presetPath);
  }

  auto suggestedName = juce::String("Adaptive Echo Preset");
  const auto samplePath = audioProcessor.getSamplePath();
  if (samplePath.isNotEmpty()) {
    suggestedName = juce::File(samplePath).getFileNameWithoutExtension();
  }

  return audioProcessor.getDefaultPresetDirectory()
      .getChildFile(suggestedName)
      .withFileExtension(adaptive_echo::plugin_files::kPresetFileExtension);
}
