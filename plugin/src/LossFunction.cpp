...
double cosine(const std::vector<double> sounds, const std::vector<double> settings){
...
double CLIP_Loss(double tau, std::vector<std::vector<double>> sounds, std::vector<std::vector<double>> settings){
